...
function RayfieldLibrary:Notify(NotificationSettings)
	spawn(function()
		...
		Notification.Parent = Notifications
		Notification.Size = UDim2.new(0, 520, 0, 160)
		Notification.BackgroundTransparency = 1

		TweenService:Create(Notification, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 590, 0, 182)}):Play()
		TweenService:Create(Notification, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.1}):Play()
		Notification:TweenPosition(UDim2.new(1,0,1.830,0),'Out','Quint',0.8,true)
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateParagraph(ParagraphSettings)
			...
			Paragraph.Content.Size = UDim2.new(0, 4380, 0, Paragraph.Content.TextBounds.Y)
			--Paragraph.Content.Position = UDim2.new(1, -10, 0,76)
			Paragraph.Size = UDim2.new(10, -100, 0, Paragraph.Content.TextBounds.Y + 400)
			...
			TweenService:Create(Paragraph, TweenInfo.new(7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
			TweenService:Create(Paragraph.UIStroke, TweenInfo.new(7, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			TweenService:Create(Paragraph.Title, TweenInfo.new(7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()	
			TweenService:Create(Paragraph.Content, TweenInfo.new(7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()	
